...
- Scarica l'ultima versione stabile dalle [release di GitHub](https://github.com/Chloemlla/Seal/releases/latest)
  - Installa la versione [pre-release](https://github.com/Chloemlla/Seal/releases/) per aiutarci a testare nuove funzionalità e trovare bug.
...
Seal rimarra sempre gratis e open-source per tutti. Se ti piace, considera [diventare uno sponsor](https://github.com/sponsors/Chloemlla)!
...
>**Nota Bene**
>
>Per inviare report di bug, richieste di feature, domande o qualsiasi altra idea per migliorare, perfavore leggi [CONTRIBUTING.md](https://github.com/Chloemlla/Seal/blob/main/CONTRIBUTING.md) per istruzioni e linee guida.
