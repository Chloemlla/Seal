...
- Преузмите најновију стабилну верзију са [GitHub издања](https://github.com/Chloemlla/Seal/releases/latest)
  - Инсталирајте [бета издања](https://github.com/Chloemlla/Seal/releases/) апликације да бисте нам помогли да тестирамо нове функције и промене 
...
Seal ће увек бити бесплатан и отвореног кода за све. Ако вам се свиђа, размислите о томе да ме [спонзоришете](https://github.com/sponsors/Chloemlla)! 
...
>**Напомена**
>
>За слање извештаја о грешкама, захтева за функције, питања или било које друге идеје за побољшање апликације, прво прочитајте [CONTRIBUTING.md](https://github.com/Chloemlla/Seal/blob/main/CONTRIBUTING.md) за упутства и смернице. 
