...
- Baixe a versão estável mais recente do [GitHub releases](https://github.com/Chloemlla/Seal/releases/latest)
  - Instale versões de "[pre-release](https://github.com/Chloemlla/Seal/releases/)" para testar novas funcionalidades e mudanças
...
O seal vai ser sempre grátis e de código aberto pra todo mundo. Se você curte o app, considere [me patrocinar](https://github.com/sponsors/Chloemlla)!
...
>[!Nota]
>
>Para enviar bug reports, sugestões de funcionalidades, questões, ou ideias para melhorias, por favor leia [CONTRIBUTING.md](https://github.com/Chloemlla/Seal/blob/main/CONTRIBUTING.md) para instruções e regras primeiro.
